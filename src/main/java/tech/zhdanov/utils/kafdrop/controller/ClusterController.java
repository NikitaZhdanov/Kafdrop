...
import tech.zhdanov.utils.kafdrop.config.CuratorConfiguration;
import tech.zhdanov.utils.kafdrop.model.BrokerVO;
import tech.zhdanov.utils.kafdrop.model.TopicVO;
import tech.zhdanov.utils.kafdrop.service.BrokerNotFoundException;
...
public class ClusterController
{
   ...
   public String clusterInfo(Model model)
   {
      ...
      model.addAttribute("consumers", kafkaMonitor.getConsumers());
