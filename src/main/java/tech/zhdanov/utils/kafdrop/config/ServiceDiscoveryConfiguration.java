...
import tech.zhdanov.utils.kafdrop.util.JmxUtils;
...
public class ServiceDiscoveryConfiguration
{
   ...
   public ServiceDiscovery curatorServiceDiscovery(
      ...
      @Value("${curator.discovery.basePath}") String basePath) throws Exception
   {
   ...
   private Integer getServicePort(EmbeddedWebApplicationContext webContext)
   {
      ...
      if (webContext != null)
      {
         ...
         if (container instanceof TomcatEmbeddedServletContainer)
         {
            ...
            port = ((TomcatEmbeddedServletContainer) container).getTomcat().getServer().getPort(); //getConnector().getPort();
         }
         else
         {
